	  	...
	  	<div class="container">
			...
			<div class='card'>
			    <div class='card-header'>
			        Sei sicuro di voler rimuovere questo regista?
			    </div>
				...
				<form:form method="post" action="${pageContext.request.contextPath}/regista/executeDelete/">
					<input type="hidden" name="idRegista" value="${show_regista_attr.id}">
